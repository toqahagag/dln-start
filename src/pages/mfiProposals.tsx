...
function MfiProposals() {
  ...
  const getProposals = async () => {
    ...
    setProposals(proposals.data.filter((prop: any) => prop.status !== ProposalStatus.drafted));
    setFilteredProposals(
      proposals.data.filter((prop: any) => prop.status !== ProposalStatus.drafted)
    );
  };
  ...
  const handleFilter = (filter) => {
    ...
    if (filter === "active") {
      data = proposals.filter(
        (prop: any) => prop.status !== ProposalStatus.drafted && prop.status !== ProposalStatus.published
      );
                    ...
                    >
                      <div className="align-self-center mt-3">
                        ...
                        <div
                          ...
                          onClick={(e) => handleFilter(ProposalStatus.published)}
                        >
