...
function InviteUsers({ data, InviteModalClosed, isBorrow = false,isCampaign=false }) {
  ...
  isCampaign?inviteForCampaignAPI(isAll,singleEmailToArr): inviteForProposalAPI(isAll,singleEmailToArr);
    }
  };
