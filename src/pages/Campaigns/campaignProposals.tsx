  ...
  return (
    <Fragment>
      {loadProposals ? (
        ...
        <>
          {loadMenu &&
            (<Menu isStart={true} isFullData={userData && userData.id !== "" ? true : false} />)
          }
                ...
                <>
                  ...
                  <Row>
                    {campaignData.campaignUrl != "" && (
                      <Col>
                        {strings.campaignUrl}:
                        <a href={campaignData.campaignUrl} target="_blank" rel="noopener noreferrer"> {campaignData.campaignUrl}</a>
                      </Col>
                  ...
                  <Row>
                    <Col>
                      {strings.donationUrl}:
                      <a href={donationUrl} target="_blank" rel="noopener noreferrer"> {donationUrl}</a>
                    </Col>
                  </Row>
                </>
              )}
