...
function VerifyCode(props) {
  ...
  const handleResend = async (e) => {
    ...
    intervalRef.current = setInterval(()=>{
      ...
      _num=_num-1;
     decreaseNum();console.log(num);}}, 1000);
  };
            ...
            <Form className="app-form">
              ...
              <Row className="justify-content-between">
                ...
                <Col className="text-right">
                  <button
                    className={`btn app-link ${isResendClicked ? "disabled" : ""}`}
                  ...
                  <br />
                 {isResendClicked&&(<span className="dln-text-mute"> Try again after {num} s</span>)} 
                </Col>
              </Row>
            </Form>
          </Card>
